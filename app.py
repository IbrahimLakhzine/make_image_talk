...
genAudioButton  =ctk.CTkButton(buttonFrame, height=40, width=120, text_font=("Arial", 20), text_color="black", text="Syn Audio", command=generateAudio)
genAudioButton.pack(side='left', padx=10)
playAudioButton =ctk.CTkButton(buttonFrame, height=40, width=120, text_font=("Arial", 20), text_color="black", text="Play Rap", command=playAudio)
playAudioButton.pack(side='left', padx=10)
genVideoButton =ctk.CTkButton(buttonFrame, height=40, width=120, text_font=("Arial", 20), text_color="black", text="Syn Video", command=generateVideo)
